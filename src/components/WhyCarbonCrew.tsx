...
// Technology icons with their brand colors
const technologies = [
  {
    name: 'React',
    icon: (
    ...
    <section className="relative w-full h-full flex-1 flex flex-col justify-center overflow-hidden bg-transparent py-2 xs:py-4 sm:pt-24 sm:pb-6">
      ...
      <div className="container mx-auto px-3 xs:px-4 sm:px-6 lg:px-8 relative z-20">
        <div className="max-w-4xl mx-auto text-center">
          {/* Header */}
          <motion.div ref={ref} className="mb-4 xs:mb-6 sm:mb-10 md:mb-12">
            <motion.span 
          ...
          <motion.div ref={techRef} className="mt-4 xs:mt-6 sm:mt-10 md:mt-12">
            <motion.h3 
              initial={{ opacity: 0, y: 20 }}
            ...
            {/* Tech Grid */}
            <motion.div 
              className="grid grid-cols-3 xs:grid-cols-4 sm:grid-cols-6 md:grid-cols-6 lg:grid-cols-6 gap-2 xs:gap-3 sm:gap-4 md:gap-5 lg:gap-6"
              initial={{ opacity: 0 }}
            ...
            >
              {technologies.map((tech, index) => (
                <motion.div
                  ...
                  animate={techInView ? { opacity: 1, y: 0, scale: 1 } : {}}
                  transition={{ 
                    duration: 0.5, 
