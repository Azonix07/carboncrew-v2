      ...
      <div className="absolute inset-0 flex items-center justify-center z-20">
        ...
        >
          <motion.button
            ...
            whileHover={isLowEnd ? {} : { scale: 1.05, boxShadow: '0 0 40px rgba(225, 29, 72, 0.4)' }}
            whileTap={{ scale: 0.98 }}
            className="group relative w-full sm:w-auto px-6 sm:px-6 lg:px-8 py-3 sm:py-3 lg:py-4 bg-gradient-to-r from-rose-500 to-red-500 rounded-full font-semibold text-white overflow-hidden text-base sm:text-base"
          >
